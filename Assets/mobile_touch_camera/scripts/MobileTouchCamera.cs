...
#pragma warning restore 414
    ...
    public void test(){
      //Position update.
      Vector3 intersectionDragCurrent;
      Debug.Log("Cam.ScreenPointToRay(new Vector3(25.2f,3.5f,-103.7f)):"+Cam.ScreenPointToRay(new Vector3(25.2f,3.5f,-103.7f)));
        intersectionDragCurrent = GetIntersectionPoint(Cam.ScreenPointToRay(new Vector3(25.2f,3.5f,-103.7f)));
      Vector3 dragUpdateVector = intersectionDragCurrent - pinchStartIntersectionCenter;
      Debug.Log("pinchStartIntersectionCenter："+pinchStartIntersectionCenter);
      Debug.Log("intersectionDragCurrent"+intersectionDragCurrent);
      Debug.Log("dragUpdateVector"+dragUpdateVector);
      Vector3 targetPos = GetClampToBoundaries(Transform.position - dragUpdateVector);
