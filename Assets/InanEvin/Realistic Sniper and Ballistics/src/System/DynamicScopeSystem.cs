...
namespace IE.RSB
{
    ...
    public class DynamicScopeSystem : Singleton<DynamicScopeSystem>
    {
        ...
        public void CameraSet(Camera main,Vector3 rotation){
            base.Awake();
            m_mainCamera = main; 
            m_mainCamera.gameObject.transform.localRotation =Quaternion.Euler(rotation);
        ...
        {
            //Debug.Log("カメラアングル①:"+m_mainCamera.transform.rotation);
            if (delay != 0.0f)
